...
public class ReturnMsg implements org.apache.thrift.TBase<ReturnMsg, ReturnMsg._Fields>, java.io.Serializable, Cloneable, Comparable<ReturnMsg> {
  ...
  public String returnMsg; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.RETURN_MSG, new org.apache.thrift.meta_data.FieldMetaData("returnMsg", org.apache.thrift.TFieldRequirementType.REQUIRED, 
  ...
  public int hashCode() {
    ...
    boolean present_returnMsg = true && (isSetReturnMsg());
    list.add(present_returnMsg);
    if (present_returnMsg)
      list.add(returnMsg);
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (returnMsg == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'returnMsg' was not present! Struct: " + toString());
    }
